...
func _run():
    if state == "":
        ...
        saynn("[say=tavi]Nice to see you too.[/say]")
    ...
    if state == "catch_up":
        ...
        saynn("[say=tavi]Nova! No! This is— this is the person I told you about. From the prison. The one who helped me with— y'know.[/say]")
    ...
    if state == "introduce":
        ...
        saynn("[say=tavi]She's taking this well.[/say]")
    ...
    if state == "too_well":
        ...
        saynn("[say=tavi]Nova's always been like this. She rolls with things. It's one of the reasons she survived the prison without turning into an asshole.[/say]")
    ...
    if state == "explain":
        ...
        saynn("[say=tavi]When you put it like that it sounds insane.[/say]")
        saynn("Nova snorts.")
    ...
    if state == "why_agree":
        ...
        saynn("[say=tavi]Thanks, Nova.[/say]")
...
func _react(_action, _args):
    if _action == "end_scene":
        GM.main.setFlag("BDCC2.Ch2_MeetNovaDone", true)
        endScene()
        return
    setState(_action)
